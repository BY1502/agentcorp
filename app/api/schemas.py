...
class RunResponse(BaseModel): run_id: UUID; mission_id: UUID; status: str; retry_count: int; changed_files: list[str]; tool_call_count: int; event_count: int; workspace_ref: str

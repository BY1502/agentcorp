...
class ApprovalStore(Protocol):
    ...
    def transition_approval(self, approval_id: UUID, expected_status: str, new_status: str, decision_reason: str | None = None) -> PendingApproval | None: ...
    def transition_approval_with_event(self, approval_id: UUID, expected_status: str, new_status: str, event: TraceEvent, decision_reason: str | None = None) -> PendingApproval | None: ...
